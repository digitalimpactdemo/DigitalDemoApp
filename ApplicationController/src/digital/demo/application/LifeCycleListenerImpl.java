package digital.demo.application;

import digital.demo.application.listeners.local.BeaconNotificationListener;
...
public class LifeCycleListenerImpl implements LifeCycleListener {
    ...
    public void start() {
        ...
        evtSource.addListener(new BeaconNotificationListener());
        try {
            DataSourceUtil.initialise();
        } catch (Exception expGeneral) {
            logger.error (METHOD_NAME, "Error initialising Local Storage Database Service.", expGeneral);
        }
    ...
    public void stop() {
        ...
        logger.begin(METHOD_NAME);
        try {
            DataSourceUtil.deInitialise();
        } catch (Exception expGeneral) {
            logger.error (METHOD_NAME, "Error de-initialising Local Storage Database Service.", expGeneral);
        }
        logger.end(METHOD_NAME);
    }
    ...
    public void activate() {
        final String METHOD_NAME = "activate";
        logger.begin(METHOD_NAME);
        BeaconManager.setApplicationActive(true);
        logger.end(METHOD_NAME);
    }
    ...
    public void deactivate() {
        final String METHOD_NAME = "deactivate";
        logger.begin(METHOD_NAME);
        BeaconManager.setApplicationActive(false);
        logger.end(METHOD_NAME);
    }
}
